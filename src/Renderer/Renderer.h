...
namespace Aegis {
	...
	void DrawQuad(const Vec2& pos, const std::shared_ptr<SubTexture>& sub_texture, const Vec4& color = { 1.0f, 1.0f, 1.0f, 1.0f });
	void DrawQuad(const Vec2& pos, const Vec2& size, const std::shared_ptr<SubTexture>& sub_texture, const Vec4& color = { 1.0f, 1.0f, 1.0f, 1.0f });
